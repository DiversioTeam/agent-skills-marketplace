...
| Package | Description |
|---------|-------------|
| `ci-status` | Checkout-scoped CI status with `/ci`, `/ci-detail`, `/ci-logs`, exact GitHub job selection, real CircleCI console output, auto-watch, and LLM tools. Ambiguous job queries fail instead of selecting a sibling. |
