...
For Pi package pages, the site now supports package-specific static OG images:

```text
public/og/pi-package-default.png
public/og/pi-dev-workflow.png
public/og/pi-ci-status.png
...
```
...
That keeps the social preview for a package page aligned with the package being
shared, instead of showing one generic site card for every Pi extension.
