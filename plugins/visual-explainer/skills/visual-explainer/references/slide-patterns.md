...
**When to use slides:** Only when the user explicitly requests them, a wrapper passes `--slides`, or the user asks in natural language for a slide deck. Never auto-select slide format.
